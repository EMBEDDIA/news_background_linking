...
def readFile(file_path, output_file, start_from=0, stop_at=-1):
	...
	with open(file_path) as file_reader:
		file_writer = open(f"{output_file}.title", mode="a")
...
logging.basicConfig(filename=f"/data/lcabrera/WashingtonPost.v4/data/wp_v4_title_{arguments[0]}.log", level=logging.INFO)
